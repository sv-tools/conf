...
This library has only one dependency of [stretchr/testify](github.com/stretchr/testify).
I will make a hard copy of it if the number of dependencies are increased.
* The [stretchr/testify](github.com/stretchr/testify) is used for testing only.
